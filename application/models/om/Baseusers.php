...
abstract class Baseusers extends BaseObject implements Persistent
{
    ...
    public function setuser($v)
    {
        ...
        if ($this->user !== $v) {
            $this->user = $v;
            $this->modifiedColumns[] = userspeer::USER;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(userspeer::USER)) {
            $modifiedColumns[':p' . $index++]  = '`USER`';
        }
        if ($this->isColumnModified(userspeer::PASS)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(userspeer::USER)) $criteria->add(userspeer::USER, $this->user);
